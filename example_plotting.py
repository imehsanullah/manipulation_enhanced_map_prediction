...
def main():
    ...
    viz.plot_ground_truth_overview(gt_data, save_path='plots/ground_truth_overview.png')

    # Example 3: Plot comparison
    print("\n5. Plotting comparison between prediction and ground truth...")
    viz.plot_comparison(sample_dir, camera_idx=0, save_path='plots/comparison.png')

    # # Example 4: Plot all cameras in a grid
    # print("\n6. Plotting all camera views in a grid...")
    # viz.plot_all_cameras_grid(hms_data, max_cameras=50, save_path='plots/all_cameras_grid.png')

    print("\nDone! All visualizations saved to 'plots/' directory.")
