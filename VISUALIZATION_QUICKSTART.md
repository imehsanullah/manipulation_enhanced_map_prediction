...
### Full Mode Output:
```
belief_visualizations_TIMESTAMP/
...
```
Output: `quick_viz/summary.png`

### 2. Paper Figure Recreation
```bash
./run_visualization.sh --full --steps 20
```
Output: `belief_visualizations_*/figure1_style_comparison.png`
...
2. Open result:
   ```bash
   xdg-open quick_viz/summary.png  # Linux
   # or
   open quick_viz/summary.png      # Mac
   ```
